...
class FilterGenderAdapter(
    ...
    override fun onBindViewHolder(holder: FilterGenderViewHolder, position: Int) {
        ...
        if (holder.radioFilter.isChecked) {
