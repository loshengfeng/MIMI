...
import com.dabenxiang.mimi.view.my_pages.pages.favorites.LikeListDataSource
...
class MyPagesPostMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            val result =
                    when(myPagesType) {
                        MyPagesType.LIKE -> domainManager.getApiRepository().getPostLike(offset.toLong(), LikeListDataSource.PER_LIMIT, 7)
                        else -> domainManager.getApiRepository().getPostFavorite( offset.toLong(), LikeListDataSource.PER_LIMIT, 7)
                    }
