...
class HomeClipAdapter(
    ...
    private val clipListener: ClipListener,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        ...
        return ClipViewHolder(view, clipClickListener, clipListener, attachmentMap)
    }
    ...
    interface ClipListener {
        fun onGetVideoImg(id: Long, position: Int, type: HomeItemType)
        fun onGetAvatar(id: Long, position: Int, type: HomeItemType)
    }
