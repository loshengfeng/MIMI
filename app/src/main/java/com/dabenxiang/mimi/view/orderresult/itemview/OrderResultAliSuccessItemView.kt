...
import kotlinx.android.synthetic.main.item_order_result_ali_successful.view.*

@ModelView(autoLayout = ModelView.Size.MATCH_WIDTH_MATCH_HEIGHT)
class OrderResultAliSuccessItemView(context: Context) : ConstraintLayout(context) {

    init {
        View.inflate(context, R.layout.item_order_result_ali_successful, this)
    }
