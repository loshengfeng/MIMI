...
class RankingDataSource constructor(
...
) : PageKeyedDataSource<Long, RankingItem>() {
    ...
    private data class InitResult(val list: List<RankingItem>, val nextKey: Long?)

    override fun loadInitial(
        params: LoadInitialParams<Long>,
        callback: LoadInitialCallback<Long, RankingItem>
    ) {
    ...
    override fun loadBefore(params: LoadParams<Long>, callback: LoadCallback<Long, RankingItem>) {
        Timber.d("loadBefore")
    }

    override fun loadAfter(params: LoadParams<Long>, callback: LoadCallback<Long, RankingItem>) {
        Timber.d("loadAfter")
        val next = params.key
        viewModelScope.launch {
            flow {
